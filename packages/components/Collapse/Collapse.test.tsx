...
describe("Collapse.vue", () => {
    beforeAll(() => {
        ...
        headers = wrapper.findAll(".viz-collapse-item__header");
        contents = wrapper.findAll(".viz-collapse-item__wapper");
    ...
    test("手风琴模式 错误处理", () => {
        ...
        [
          [
            [VizUIError: [VizCollapse] accordion mode should only have one active item],
          ],
        ]
      `
        );
