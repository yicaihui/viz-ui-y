...
import { useZIndex } from '@viz-ui-y/hooks'
import LoadingComp from './Loading.vue'
import { delay, isNil, isString } from 'lodash-es'

const RELATIVE_CLASS = 'viz-loading-parent--relative' as const
const HIDDEN_CLASS = 'viz-loading-parent--hiden' as const
const LOADING_NUMB_KEY = 'viz-loading-numb' as const
