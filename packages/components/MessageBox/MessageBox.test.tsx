...
describe('MessageBox Component', () => {
  it('renders correctly', async () => {
    ...
    MessageBox(props)
    await rAF()
    const header = document.querySelector('.viz-message-box__header')
    const title = document.querySelector('.viz-message-box__title')
    const message = document.querySelector('.viz-message-box__message')
